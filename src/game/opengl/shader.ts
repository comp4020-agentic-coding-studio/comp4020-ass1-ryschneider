/** Compiles one shader stage, throwing the driver's info log on failure instead of returning a dead handle. */
...
/** Links a vertex + fragment shader pair into a program. The intermediate shader objects are freed once linked. */
